...
# Self-awareness: embrace yourself
...
# Build a process-driven portfolio — even if it's not based on real cases
...
# Show you're into the company you're applying
...
# Don't worry: the journey of a designer is never over
